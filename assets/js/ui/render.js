...
export function renderizarEstadoCarregando() {
    definirTexto('dashboard-status', 'Carregando indicadores...');
}
export function renderizarErro(mensagem) {
...
export function renderizarIndicadores(indicadores, metricas, produtoDestaque) {
    ...
    const qtdDestaque = produtoDestaque?.quantidade ?? indicadores.qtd_produto_destaque;
...
export function renderizarTabelaCategorias(categorias) {
...
export function renderizarTabelaRanking(ranking) {
...
export function renderizarTabelaPedidos(pedidos) {
